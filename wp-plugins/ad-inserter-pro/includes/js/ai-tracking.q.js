...
//          var matches = navigator.userAgent.match(/(msie) ([\w.]+)/i);
      ...
      // ### AI
//      ai_iframeTracker_instance = this;
      // ### /AI
...
//    var blocks_for_tracking = $("div.ai-track[data-ai]:visible, div.ai-rotate[data-info]:visible div.ai-track[data-ai]", block_wrapper);
    var blocks_for_tracking = $("div.ai-track[data-ai]:visible:not(.ai-no-pageview), div.ai-rotate[data-info]:visible div.ai-track[data-ai]:not(.ai-no-pageview)", block_wrapper);

    if (typeof $(block_wrapper).attr ("data-ai") != "undefined" && $(block_wrapper).hasClass ('ai-track') && $(block_wrapper).is (':visible') && !$(block_wrapper).hasClass ('ai-no-pageview')) {
...
//                var ai_masking_data = jQuery(b64d ("Ym9keQ==")).attr (AI_ADB_ATTR_NAME);
                var ai_masking_data = jQuery(b64d ("Ym9keQ==")).attr (b64d (ai_adb_attribute));
