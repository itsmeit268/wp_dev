...
vc_map( array(
	...
	"icon"					=> ES_ADMIN_ASSETS_URL.'/images/vc-icon.png',
    ...
    "params"                => array(
		...
		//Tab1 Settings
				array(
					'type' 			=> 'checkbox',
					'heading' 		=> esc_html__( 'Enable', 'pl-emallshop-extensions' ),
					'param_name' 	=> 'tab1_enable',
					'value' 			=> array( esc_html__( 'Yes, please', 'pl-emallshop-extensions' ) => 1 ),
					'std' 				=> 1,
					'dependency'     => array(
						 'element'	=> 'category_products_tab_style',
						 'value'	=> array('only_products_tab','title_with_products_tab'),
					),
					'group' 		=> esc_html__( 'Tab1', 'pl-emallshop-extensions' ),
				),
				array(
					'type' 			=> 'textfield',
					'heading' 		=> esc_html__( 'Title', 'pl-emallshop-extensions' ),
					'param_name' 	=> 'tab1_title',
					'std' 			=> esc_html__('Recent Products','pl-emallshop-extensions'),
					'dependency'     => array(
						 'element'	=> 'category_products_tab_style',
						 'value'	=> array('only_products_tab','title_with_products_tab'),
					),
				...
				array(
					...
					'heading'     	=> esc_html__( 'Data source', 'pl-emallshop-extensions' ),
					'value'       	=> array(
						...
						esc_html__( 'Top Rated Products', 'pl-emallshop-extensions' )    => 'top-reviews-products',
						esc_html__( 'On Sale Products', 'pl-emallshop-extensions' )      => 'sale-products',
					),
					'std' 			=> 'recent-products',
					'description' 	=> esc_html__( 'Select data source for tab1', 'pl-emallshop-extensions' ),
					'dependency'     => array(
						 'element'	=> 'category_products_tab_style',
						 'value'	=> array('only_products_tab','title_with_products_tab'),
					),
				...
				array(
					...
					'group' 		=> esc_html__( 'Tab2', 'pl-emallshop-extensions' ),
				),
				array(
					'type' 			=> 'textfield',
					'heading' 		=> esc_html__( 'Title', 'pl-emallshop-extensions' ),
					'param_name' 	=> 'tab2_title',
					'std' 			=> esc_html__('Best Selling','pl-emallshop-extensions'),
					'dependency'     => array(
						 'element'	=> 'category_products_tab_style',
						 'value'	=> array('only_products_tab','title_with_products_tab'),
					),
				...
				array(
					...
					'std' 			=> 'best-seller-products',
					'description' 	=> esc_html__( 'Select data source for tab2', 'pl-emallshop-extensions' ),
					'dependency'     => array(
						 'element'	=> 'category_products_tab_style',
						 'value'	=> array('only_products_tab','title_with_products_tab'),
					),
				...
				array(
					...
					'group' 		=> esc_html__( 'Tab3', 'pl-emallshop-extensions' ),
				),
				array(
					'type' 			=> 'textfield',
					'heading' 		=> esc_html__( 'Title', 'pl-emallshop-extensions' ),
					'param_name' 	=> 'tab3_title',
					'std' 			=> esc_html__('Featured Products','pl-emallshop-extensions'),
					'dependency'     => array(
						 'element'	=> 'category_products_tab_style',
						 'value'	=> array('only_products_tab','title_with_products_tab'),
					),
				...
				array(
					...
					'description' 	=> esc_html__( 'Select data source for tab3', 'pl-emallshop-extensions' ),
					'dependency'     => array(
						 'element'	=> 'category_products_tab_style',
						 'value'	=> array('only_products_tab','title_with_products_tab'),
					),
				...
				array(
					...
					'group' 		=> esc_html__( 'Tab4', 'pl-emallshop-extensions' ),
				),
				array(
					'type' 			=> 'textfield',
					'heading' 		=> esc_html__( 'Title', 'pl-emallshop-extensions' ),
					'param_name' 	=> 'tab4_title',
					'std' 			=> esc_html__('Top Reviews','pl-emallshop-extensions'),
					'dependency'     => array(
						 'element'	=> 'category_products_tab_style',
						 'value'	=> array('only_products_tab','title_with_products_tab'),
					),
				...
				array(
					...
					'std' 			=> 'top-reviews-products',
					'description' 	=> esc_html__( 'Select data source for tab4', 'pl-emallshop-extensions' ),
					'dependency'     => array(
						 'element'	=> 'category_products_tab_style',
						 'value'	=> array('only_products_tab','title_with_products_tab'),
					),
				...
				array(
					...
					'group' 		=> esc_html__( 'Tab5', 'pl-emallshop-extensions' ),
				),
				array(
					'type' 			=> 'textfield',
					'heading' 		=> esc_html__( 'Title', 'pl-emallshop-extensions' ),
					'param_name' 	=> 'tab5_title',
					'std' 			=> esc_html__('Sale Products','pl-emallshop-extensions'),
					'dependency'     => array(
						 'element'	=> 'category_products_tab_style',
						 'value'	=> array('only_products_tab','title_with_products_tab'),
					),
				...
				array(
					...
					'std' 			=> 'sale-products',
					'description' 	=> esc_html__( 'Select data source for tab5', 'pl-emallshop-extensions' ),
					'dependency'     => array(
						 'element'	=> 'category_products_tab_style',
						 'value'	=> array('only_products_tab','title_with_products_tab'),
					),
...
class WPBakeryShortCode_Category_Products_Tab extends WPBakeryShortCode {
    protected function content($atts, $content = null) {
        ...
        extract( shortcode_atts( array(
			...
			"products_row"   => 1,
			'tab1_enable' 					=> 1,		
			'tab1_title' 					=> esc_html__('Recent Products','pl-emallshop-extensions'),		
			'tab1_data_source' 				=> 'recent-products',		
			'tab2_enable' 					=> 1,
			'tab2_title' 					=> esc_html__('Best Selling','pl-emallshop-extensions'),		
			'tab2_data_source' 				=> 'best-seller-products',
			'tab3_enable' 					=> 1,
			'tab3_title' 					=> esc_html__('Featured Products','pl-emallshop-extensions'),		
			'tab3_data_source' 				=> 'featured-products',
			'tab4_enable' 					=> 1,
			'tab4_title' 					=> esc_html__('Top Reviews','pl-emallshop-extensions'),		
			'tab4_data_source' 				=> 'top-reviews-products',
			'tab5_enable' 					=> 1,
			'tab5_title' 					=> esc_html__('Sale Products','pl-emallshop-extensions'),		
			'tab5_data_source' 				=> 'sale-products',
            "auto_play"      => "false",
			"loop"    		 => "false", 
            "navigation"     => "true",
            "dots"         	 => "false",
		...
		if($category_products_tab_style != "title_with_sub_categories"){
			...
			/* $tabs = array();
			if( $tab1_enable && ! empty( $tab1_title ) ){
				$query 		= emallshop_get_products($atts['tab1_data_source'], $atts );
				$the_query 	= new WP_Query( $query );			
				$tabs[] 		= array( 'id'=> 'emallshop-product-tab-' . emallshop_uniqid('tab-'),'title' => $tab1_title, 'data_source' => $tab1_data_source, 'query' => $the_query );
			}
			...
			$tabs = array();
			if( $atts['tab1_enable'] && ! empty( $atts['tab1_title'] ) ){
				$query 		= emallshop_get_products($atts['tab1_data_source'], $atts );
				$the_query 	= new WP_Query( $query );			
				$tabs[] 		= array( 'id'=> 'emallshop-product-tab-' . emallshop_uniqid('tab-'),'title' => $atts['tab1_title'], 'data_source' => $atts['tab1_data_source'], 'query' => $the_query );
			}
			if( $atts['tab2_enable'] && ! empty( $atts['tab2_title'] ) ){
				$query 		= emallshop_get_products($atts['tab2_data_source'], $atts );
				$the_query 	= new WP_Query( $query );
				$tabs[] 		= array( 'id'=> 'emallshop-product-tab-' .emallshop_uniqid('tab-'),'title' => $atts['tab2_title'], 'data_source' => $atts['tab2_data_source'], 'query' => $the_query );
			}
			if( $atts['tab3_enable'] && ! empty( $atts['tab3_title'] ) ){
				$query 		= emallshop_get_products($atts['tab3_data_source'], $atts );
				$the_query 	= new WP_Query( $query );
				$tabs[] 		= array( 'id'=> 'emallshop-product-tab-' . emallshop_uniqid('tab-'),'title' => $atts['tab3_title'], 'data_source' => $atts['tab3_data_source'], 'query' => $the_query );
			}
			if( $atts['tab4_enable'] && ! empty( $atts['tab4_title'] ) ){
				$query 		= emallshop_get_products($atts['tab4_data_source'], $atts );
				$the_query 	= new WP_Query( $query );
				$tabs[] 		= array( 'id'=> 'emallshop-product-tab-' .emallshop_uniqid('tab-'),'title' => $atts['tab4_title'], 'data_source' => $atts['tab4_data_source'], 'query' => $the_query );
			}
			if( $atts['tab5_enable'] && ! empty( $atts['tab5_title'] ) ){
				$query 		= emallshop_get_products($atts['tab5_data_source'], $atts );
				$the_query 	= new WP_Query( $query );
				$tabs[] 		= array( 'id'=> 'emallshop-product-tab-' . emallshop_uniqid('tab-'),'title' => $atts['tab5_title'], 'data_source' => $atts['tab5_data_source'], 'query' => $the_query );
			}
		}
		//var_dump( $tabs );
        $id = uniqid();
		...
		<div id="section-<?php echo esc_attr($id);?>" class="product-section <?php echo esc_attr($shortcode_class);?>">
			...
			<?php }else{?>
				...
				<div class="section-header">
					...
					foreach($tabs as $tab_data){ ?>
						<li <?php echo  $t == 0 ? 'class="active"': '' ?>>
							<a href="#<?php echo esc_html($tab_data['id']);?>" data-toggle="tab"><?php echo esc_html($tab_data['title']);?></a>
						</li>						
					<?php $t++; 
					} ?> 
					<?php /*  
				...
				<div class="section-content woocommerce">
					...
					<?php $p = 0;
					foreach( $tabs as $tab_data ){
						if ( $tab_data['query']->have_posts() ) :?>
						<div class="tab-pane fade<?php echo  $p == 0 ? ' in active': '' ?>" id="<?php echo esc_html($tab_data['id']);?>">
							<?php $row=1;?>
							<div class="product-items">
								<ul class="products product-carousel owl-carousel <?php echo esc_attr($product_style);?>">
								<?php while ( $tab_data['query']->have_posts() ) : $tab_data['query']->the_post(); ?>
									<?php if($row==1){?>
										<li class="slide-row">
											<ul>
									<?php }?>
												<?php wc_get_template_part( 'content', 'product' ); ?>
									<?php if($row==$products_row || $tab_data['query']->current_post+1==$tab_data['query']->post_count){ $row=0;?>
											</ul>
										</li>
									<?php } $row++;?>
								<?php endwhile; // end of the loop. 
