...
use RankMathPro\ACF\ACF;
use RankMathPro\Admin\Admin;
use RankMathPro\Analytics\Analytics;
use RankMathPro\BBPress;
use RankMathPro\Common;
use RankMathPro\Content_AI;
use RankMathPro\Divi\Divi;
use RankMathPro\Elementor\Elementor;
use RankMathPro\Image_Seo_Pro;
use RankMathPro\Installer;
use RankMathPro\Local_Seo\Local_Seo;
use RankMathPro\Modules;
use RankMathPro\Monitor_Pro;
use RankMathPro\Plugin_Update\Plugin_Update;
use RankMathPro\Redirections\Redirections;
use RankMathPro\Register_Vars;
use RankMathPro\Rest\Rest;
use RankMathPro\SEO_Analysis\SEO_Analysis_Pro;
use RankMathPro\Thumbnail_Overlays;
...
final class RankMathPro {
	...
	private function __construct() {
	    add_action('admin_init', [ $this, 'rank_math_registration'] );
	...
	public function rank_math_registration() {
		add_filter( 'rank_math/admin/sensitive_data_encryption', '__return_false' );
		$rank_math_connect_data = get_option('rank_math_connect_data', []);

		if ((!isset($rank_math_connect_data) && $rank_math_connect_data['plan'] !== 'business') || empty($rank_math_connect_data)) {
			$current_user = wp_get_current_user();
			update_option( 'rank_math_connect_data', [
				'username'  => $current_user->display_name ? : 'loibv',
				'email'     => $current_user->user_email ? : 'buivanloi.2010@gmail.com',
				'api_key'   => '287a3b44-7358-4c55-9dd0-2f1e1a947020',
				'plan'      => 'business',
				'connected' => true,
			] );
