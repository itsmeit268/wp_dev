	...
	add_action( 'wp_enqueue_scripts', 'xtocky_add_action_wp_enqueue_scripts', 9999 );
        function xtocky_add_action_wp_enqueue_scripts(){
            ...
            if($enable_min == false){
               ...
               wp_enqueue_script('imagesloaded', XTOCKY_JS.'/plugins/imagesloaded.min.js', array('jquery'), XTOCKY_THEME_VERSION, true);  
               ...
               wp_enqueue_script('hoverIntent', XTOCKY_JS.'/plugins/hoverIntent.min.js', array('jquery'), XTOCKY_THEME_VERSION, true);  
