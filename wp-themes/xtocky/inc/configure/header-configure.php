...
//modify added block  Version: 2.4.2
if ( !function_exists( 'xtocky_get_header_cart' ) ){
    function xtocky_get_header_cart(){
        ...
        $drawer = xtocky_get_option_data('show_cart_drawer', '1');
        $cart_price = xtocky_get_option_data('show_cart_price', '0');

       $drawer1 =   $drawer ? 'open_drawer' : 'close_drawer';
       $cart_price2 = $cart_price ? '' : ',"hasHiddenPrice":true';
        
         if(function_exists('WC') && $show_cart == 1):?>
            <div class="dropdown header-dropdown cart-dropdown">
            <?php
            $block_content = '<!-- wp:woocommerce/mini-cart {"addToCartBehaviour":"'. $drawer1.'"'.$cart_price2.'} /-->';
