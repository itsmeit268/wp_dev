...
Redux::setSection($opt_name, array(
    ...
    'fields'     => array(
        ...
        array(
            'id'      => 'show_cart_drawer',
            'type'    => 'switch',
            'title' => esc_html__('Open cart in a drawer', 'xtocky'),
            'default' => '1',
        ...
        array(
            'id'      => 'show_cart_price',
            'type'    => 'switch',
            'title' => esc_html__('Show Cart Price', 'xtocky'),
            'default' => '0',
            'required' => array('show_cart_iocn', '=', 1)
        ),
        array(
...
Redux::setSection($opt_name, array(
    ...
    'fields'     => array(
        ...
        array(
            ...
            'transparent' => false,
            'output'    => array(
                'background-color' => '.header-layout-7 .header-search-container .btn,.dropdown.header-dropdown.btn-checkout a,.header-search-container .btn,.header-dropdown.cart-dropdown > a .badge-number',
                'color' => '.header-dropdown button,.header-dropdown button:hover,.header-dropdown button[disabled]:hover, .header-dropdown button[disabled]:focus'
                )
        ),
        array(
