        ...
        <div id="reviews" class="tab-carousel-container w-1380 clearfix products-tab" role="tabpanel">
            <ul class="nav text-uppercase text-center <?php echo esc_attr($tab_class); ?>" role="tablist">
                ...
                <?php foreach ($product_tabs as $key => $product_tab) :
                    ...
                    ?>
                    <li class="<?php echo esc_attr($active); ?>" role="presentation" data-target="tab-<?php echo esc_attr($key); ?>">
            ...
            <div class="tab-content">
                <?php foreach ($product_tabs as $key => $product_tab) :
                    ...
                    ?>
                    <div role="tabpanel" class="tab-pane <?php echo esc_attr( 'tab-'.$key.' ' . $active_class); ?>" id="tab-<?php echo esc_attr($key); ?>">
