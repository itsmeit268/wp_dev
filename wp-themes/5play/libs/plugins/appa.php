...
class edd_theme_updater {
    ...
    function __construct($args = array(), $strings = array()){
        $args = wp_parse_args($args, array("remote_api_url" => exthemes, "request_data" => array(), "theme_slug" => get_template(), "item_name" => '', "license" => '', "version" => '', "author" => ''));
        extract($args);
    ...
    function update_nag() {
        ...
        $update_onclick = " onclick=\"if (confirm('" . esc_js($strings["update-notice"]) . "')) {
            return true;
        } 
        return false;\"";
        include EX_THEMES_DIR . "/libs/plugins/lima.php";
    }
