...
if (!class_exists($checks)) {
    include EX_THEMES_DIR . "/libs/plugins/tallu.php";
}
...
$updater = new $checks(
    ...
    $strings = array(
        ...
        "expires-never" => __("Never expired", THEMES_NAMES), "customer-name-%1$s" => __("Customer <b>%1$s</b>", THEMES_NAMES),
        ...
        "update-available2" => __("<b>%1$s %2$s</b> Themes is available. <br><a href=\"/wp-admin/admin.php?page=wp__changelogs\" class=\"thickbox\" title=\"%4s\">Check out what's new</a> or <a href=\"%5$s\"%6$s>update now</a>", THEMES_NAMES),
