...
<div style="display: block;margin-left: auto;margin-right: auto;width: 50%;"  class="fb-like" data-href="https://exthem.es/" data-layout="standard" data-action="like" data-show-faces="true" data-share="true"></div>
		...
		<br><br>
          <a href="https://www.telegram.dog/exthemes_helps" target="_blank" class="telegramim_button telegramim_shadow telegramim_pulse" style="font-size:15px;width:200px;background:#2DA5D9;box-shadow:1px 1px 5px #2DA5D9;color:#FFFFFF;border-radius:50px;" title="Join Now"><i class="ftelegramim ftelegramim-telegram-logo"></i> Join on Telegram <small><span class="telegramim_count" data-for="@exthemes_helps"></span> Participants</small></a>
</center>
</div>
</div>
<script>
