<?php
/**
 * Widget API: Dlpro_Toprate_Widget class
 *
 * Author: Gian MR - http://www.gianmr.com
 * Require Rate my Post – WP Rating System https://wordpress.org/plugins/rate-my-post/
 *
 ...
 * @see WP_Widget
 */
class Dlpro_Toprate_Widget extends WP_Widget {
	/**
	 * Sets up a Top rate posts widget instance.
	 *
	 * @since 1.0.0
	 * @access public
	 */
	public function __construct() {
		$widget_ops = array(
			...
			'description' => __( 'Top Rate Softwares with thumbnails widget.', 'dlpro' ),
		);
		parent::__construct( 'dlpro-toprate', __( 'Top Rate Softwares (Dlpro)', 'dlpro' ), $widget_ops );
	...
	public function form( $instance ) {
		...
		<p>
			...
			<label for="<?php echo esc_html( $this->get_field_id( 'dpr_show_view' ) ); ?>"><?php esc_html_e( 'Show Rate?', 'dlpro' ); ?></label>
		</p>
		<p>
...
add_action(
	'widgets_init',
	function() {
		register_widget( 'Dlpro_Toprate_Widget' );
	}
);
