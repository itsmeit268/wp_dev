	...
	public function render_meta_box_content( $post ) {
		...
		<p>
			<select name="catmode_field">
				<option value=""><?php echo esc_attr( __( 'Select category', 'dlpro' ) ); ?></option>
				<?php
		...
		<p><?php esc_html_e( 'Please select category if you using page attribute, best rating, order by modified, title or year.', 'dlpro' ); ?></p>
