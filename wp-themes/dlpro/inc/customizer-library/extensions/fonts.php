...
if ( ! function_exists( 'customizer_library_get_font_choices' ) ) :
	...
	function customizer_library_get_all_fonts() {
		$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'dlpro' ) ) ) );
		$standard_fonts = customizer_library_get_standard_fonts();
		$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'dlpro' ) ) ) );
...
if ( ! function_exists( 'customizer_library_get_google_font_subsets' ) ) :
	...
	function customizer_library_get_google_font_subsets() {
		return array(
			'all'          => __( 'All', 'dlpro' ),
			'cyrillic'     => __( 'Cyrillic', 'dlpro' ),
			'cyrillic-ext' => __( 'Cyrillic Extended', 'dlpro' ),
			'devanagari'   => __( 'Devanagari', 'dlpro' ),
			'greek'        => __( 'Greek', 'dlpro' ),
			'greek-ext'    => __( 'Greek Extended', 'dlpro' ),
			'khmer'        => __( 'Khmer', 'dlpro' ),
			'latin'        => __( 'Latin', 'dlpro' ),
			'latin-ext'    => __( 'Latin Extended', 'dlpro' ),
			'vietnamese'   => __( 'Vietnamese', 'dlpro' ),
		);
	}
endif;
...
if ( ! function_exists( 'customizer_library_get_standard_fonts' ) ) :
	...
	function customizer_library_get_standard_fonts() {
		return array(
			'serif'      => array(
				'label' => _x( 'Serif', 'font style', 'dlpro' ),
				'stack' => 'Georgia,Times,"Times New Roman",serif',
			),
			'sans-serif' => array(
				'label' => _x( 'Sans Serif', 'font style', 'dlpro' ),
				'stack' => '"Helvetica Neue",sans-serif',
			),
			'monospace'  => array(
				'label' => _x( 'Monospaced', 'font style', 'dlpro' ),
