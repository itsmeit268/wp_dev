	...
	<article id="post-<?php the_ID(); ?>" class="item overlay-layout hentry">
		<div class="penci-overlay-over">
			<div class="thumbnail">
				...
				<a class="penci-image-holder penci-lazy" data-bgset="<?php echo penci_get_featured_image_size( get_the_ID(), 'penci-full-thumb' ); ?>" href="<?php the_permalink(); ?>" aria-label="<?php echo wp_strip_all_tags( get_the_title() ); ?>" title="<?php echo wp_strip_all_tags( get_the_title() ); ?>">
				</a>
				<?php } else { ?>
				<a class="penci-image-holder" style="background-image: url('<?php echo penci_get_featured_image_size( get_the_ID(), 'penci-full-thumb' ); ?>');" href="<?php the_permalink(); ?>" aria-label="<?php echo wp_strip_all_tags( get_the_title() ); ?>" title="<?php echo wp_strip_all_tags( get_the_title() ); ?>">
				</a>
				<?php } ?>
			</div>

			<a class="overlay-border" aria-label="<?php echo wp_strip_all_tags( get_the_title() ); ?>" href="<?php the_permalink() ?>"></a>
			...
			<div class="overlay-header-box">
				...
				<?php if ( ! get_theme_mod( 'penci_grid_author' ) ) : ?>
					<div class="penci-meta-author overlay-author byline"><span class="author-italic author vcard"><?php echo penci_get_setting( 'penci_trans_written_by' ); ?> <?php if ( function_exists( 'coauthors_posts_links' ) ) :
