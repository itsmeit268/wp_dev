	...
	class PENCI_FW_Social_Counter {
		...
		public static function format_followers( $followers ) {
			...
			if ( $followers >= 1000000 ) {
				$followers = number_format_i18n( $followers / 1000000, 1 ) + 0 . penci_get_setting( 'penci_trans_m_number' );
			} elseif ( $followers >= 1000 ) {
				$followers = number_format_i18n( $followers / 1000, 1 ) + 0 . penci_get_setting( 'penci_trans_k_number' );
			} else {
