...
class Penci_Soledad_Dashboard {
	...
	public function enqueue_scripts( $hook ) {
		...
		wp_enqueue_media();
		wp_enqueue_style( 'dashboard-style', get_template_directory_uri() . '/inc/dashboard/css/dashboard-style.css', array(), PENCI_SOLEDAD_VERSION );
		wp_enqueue_script( 'soledad-button-script', get_template_directory_uri() . '/inc/woocommerce/js/jquery-grid-picker.js', array( 'jquery' ), PENCI_SOLEDAD_VERSION );
		wp_enqueue_script( 'soledad-dashboard-script', get_template_directory_uri() . '/inc/dashboard/js/script.js', array( 'jquery' ), $ver );
