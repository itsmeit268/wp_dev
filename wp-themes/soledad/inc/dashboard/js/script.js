...
(function ($) {
        $(document).ready(function ($) {
            ...
            $(document).on('click', '.penci-license-notice .notice-dismiss', function (e) {
                e.preventDefault();
                var t = $(this),
                    checkdata = {
...
(function ($) {
    var sidebar_generator = function () {
        ...
        $(document).on('click', '.penci-add-sidebar, .penci-remove-sidebar', function (e) {
                    ...
                    if (response.success && 'add' == response.data.type) {
                        ...
                        table
                            .append(
                                ...
                                + response.data.slug + '</td><td><button class="button button-small penci-remove-sidebar" data-type="remove" data-slug="'
