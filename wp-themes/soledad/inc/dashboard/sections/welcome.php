...
<div class="about-text"><?php echo sprintf( __( "Thank you for purchasing our theme! We're happy when having a new great customer like you.<br>You can join with other users that love to use Soledad to build their websites on <a target='_blank' href='https://www.facebook.com/groups/soledad/'>Soledad Users Group Here</a>. This is a platform for sharing, showcase your works, assist, discuss, and updates.", 'soledad' ), penci_get_theme_author() ); ?>
