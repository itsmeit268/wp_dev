...
class PagesOption extends CustomizerOptionAbstract {
	...
	public function set_section() {
		...
		$this->add_lazy_section( 'penci_section_spage_header_section', esc_html__( 'Page Header', 'soledad' ), $this->panelID, 'Please check <a class="wp-customizer-link" target="_blank" href="https://imgresources.s3.amazonaws.com/page-header.png">this image</a> to know what is "Page Header"' );
