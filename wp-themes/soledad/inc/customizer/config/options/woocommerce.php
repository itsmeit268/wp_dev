...
class WooCommerceOption extends CustomizerOptionAbstract {
	...
	public function set_section() {
		$this->add_lazy_section( 'pencidesign_new_section_woocommerce_section', esc_html__( 'General', 'soledad' ), $this->panelID, 'You can check <a class="wp-customizer-link" href="https://soledad.pencidesign.net/soledad-document/#create_store" target="_blank">this guide</a> to know how to configure your online store.' );
		$this->add_lazy_section( 'pencidesign_woo_product_catalog_section', esc_html__( 'Shop Settings', 'soledad' ), $this->panelID, 'You can check <a class="wp-customizer-link" href="https://soledad.pencidesign.net/soledad-document/#create_store" target="_blank">this guide</a> to know how to configure your online store.' );
