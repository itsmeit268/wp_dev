...
class PenciSoledadCodeStarOptions {
	...
	public function __construct() {
		...
		require_once get_template_directory() . '/inc/options/framework/classes/setup.class.php';
		require_once get_template_directory() . '/inc/options/custom-fields/btn-field.php';
		require_once get_template_directory() . '/inc/options/custom-fields/import-field.php';
		require_once get_template_directory() . '/inc/options/custom-fields/export-field.php';
		require_once get_template_directory() . '/inc/options/custom-fields/spacing-field.php';
		require_once get_template_directory() . '/inc/options/custom-fields/sizes-field.php';
	...
	public function admin_js() {
		wp_enqueue_script( 'csf_js_sidebar', get_template_directory_uri() . '/js/theia-sticky-sidebar.js', array( 'jquery' ), PENCI_SOLEDAD_VERSION, true );
		wp_enqueue_script( 'csf_heading_field', get_template_directory_uri() . '/inc/options/js/heading-field.js', array( 'jquery' ), PENCI_SOLEDAD_VERSION, true );
	}
	...
	public function get_options_data() {
		...
		$default_theme_options = array(
			...
			'penci_portfolio_section_panel'              => array(
				'priority'                                => 18,
				'panel'                                   => array(
