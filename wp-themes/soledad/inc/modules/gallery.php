...
if ( ! class_exists( 'Penci_Add_Options_To_Gallery_Setting' ) ) {
	class Penci_Add_Options_To_Gallery_Setting {
		...
		public function wp_enqueue_media() {
			...
			wp_enqueue_script( 'penci-custom-gallery-options', get_template_directory_uri() . '/js/admin-gallery.js', array(
				'jquery',
				'media-views'
			) );
			...
			wp_enqueue_script( 'penci-custom-gallery-options-new', get_template_directory_uri() . '/js/admin-gallery-new.js', array(
				'jquery',
				'media-views'
			) );
		}
