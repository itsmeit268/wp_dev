<?php
define('PENCI_SOLEDAD_VERSION', '8.4.5');
/**
...
if (!function_exists('penci_load_scripts')) {
	...
	function penci_load_scripts() {
		...
		wp_enqueue_style('penci-swiper-bundle', get_template_directory_uri() . '/css/swiper-bundle.min.css', array(), PENCI_SOLEDAD_VERSION);
		...
		// Enqueue script
		wp_enqueue_script('js-cookies', get_template_directory_uri() . '/js/js-cookies.js', '', PENCI_SOLEDAD_VERSION, true);
		wp_register_script('pc-lazy', get_template_directory_uri() . '/js/penci-lazy.js', '', PENCI_SOLEDAD_VERSION, true);

        wp_register_script('gsap', get_template_directory_uri() . '/js/gsap.min.js', '', PENCI_SOLEDAD_VERSION, true);
		wp_register_script('ff40', get_template_directory_uri() . '/js/ff40.js', '', PENCI_SOLEDAD_VERSION, true);
		...
		wp_register_script('jquery.inview', get_template_directory_uri() . '/js/inview.js', array(), PENCI_SOLEDAD_VERSION, true);


		if (get_theme_mod('penci_enable_reading_bar')) {
			wp_enqueue_script('penci-header-scroll', get_template_directory_uri() . '/js/header-scroll.js', array('jquery','jquery.inview'), PENCI_SOLEDAD_VERSION, true);
		}

		wp_enqueue_script('penci-sticky-share', get_template_directory_uri() . '/js/sticky_share.js', array('jquery','jquery.inview'), PENCI_SOLEDAD_VERSION, true);

		if (get_theme_mod('penci_textshare_enable')){
			$share_services = explode(',',get_theme_mod('penci_textshare_services','facebook,twitter'));
        	wp_enqueue_script('penci-selection-sharer', get_template_directory_uri() . '/js/selection-sharer.js', array('jquery'), PENCI_SOLEDAD_VERSION, true);
        	wp_localize_script(
...
require trailingslashit(get_template_directory()) . 'inc/widgets/categories_stylist.php';
...
require trailingslashit(get_template_directory()) . 'inc/widgets/stylisted_articles_count.php';
...
if (function_exists('register_block_type')) {
	...
	require get_template_directory() . '/inc/block/heading-styles/heading-title-block.php';
}
