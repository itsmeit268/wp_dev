...
if ( ! function_exists( 'foxiz_register_options_single_post_types_layout' ) ) {
	...
	function foxiz_register_options_single_post_types_layout() {
		...
		return [
			'title'      => esc_html__( 'Post Types Layout', 'foxiz' ),
		...
		return [
			...
			'fields'     => [
				...
				[
					...
					'title'    => esc_html__( 'Right Share Bar', 'foxiz' ),
					'subtitle' => esc_html__( 'Select a layout for the single entry meta bar.', 'foxiz' ),
					'type'     => 'select',
					'options'  => [
				...
				[
					...
					'type'     => 'switch',
					'title'    => esc_html__( 'Top Entry Meta Border', 'foxiz' ),
					'subtitle' => esc_html__( 'Display a top gray border in the single entry meta bar', 'foxiz' ),
					'default'  => false,
				],
				[
