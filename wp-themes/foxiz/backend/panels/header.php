		...
		return [
			...
			'fields'     => [
				...
				[
					...
					'subtitle'    => esc_html__( 'Input a Ruby Template shortcode to display in the mobile collapse section.', 'foxiz' ),
				...
				[
					...
					'type'        => 'color_gradient',
					'title'       => esc_html__( 'Collapse Section Background', 'foxiz' ),
					'subtitle'    => esc_html__( 'Select a background color for the collapse section in dark mode.', 'foxiz' ),
					'validate'    => 'color',
					'transparent' => false,
					'default'     => [
						'from' => '',
				...
				[
					...
					'title'       => esc_html__( 'Collapse Section - Text Color', 'foxiz' ),
					'subtitle'    => esc_html__( 'Select a text color for menu item, sub menu item and other elements for displaying in the collapse section in dark mode.', 'foxiz' ),
					'type'        => 'color',
					'transparent' => false,
					'validate'    => 'color',
				],
		...
		return [
			...
			'fields'     => [
				[
					...
					'type'     => 'info',
					'style'    => 'warning',
					'subtitle' => esc_html__( 'The alert bar will not be available if you use a header template.', 'foxiz' ),
					'default'  => false,
				],
				[
					...
					'type'     => 'info',
					'style'    => 'info',
					'subtitle' => esc_html__( 'You can use Elementor text and button to build an alert bar for the header templates.', 'foxiz' ),
					'default'  => false,
				],
				[
					'id'          => 'alert_bar',
