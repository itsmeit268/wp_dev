			...
			'fields' => [
				...
				[
					...
					'notice' => [
						...
						esc_html__( 'Note: This setting is only available if you use the built-in schema. If you use a third-party schema plugin, the date information will be controlled by that plugin.', 'foxiz' ),
				...
				[
					...
					'title'       => esc_html__( 'Show Updated Date on Google Search', 'foxiz' ),
					'subtitle'    => esc_html__( 'Force Google to display the updated date on search results', 'foxiz' ),
