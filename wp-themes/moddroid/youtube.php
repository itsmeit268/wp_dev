...
<body> 
	...
	<h2></h2>
	<h2 style="text-align: center;text-transform: uppercase;margin-top: 5rem;">Documentation</h2>
	
<section class="columns">
	<div class="column" >
	<h2 style="text-align: center;text-transform: uppercase;">HOW TO SEE LICENSE KEY CODE</h2>
	<iframe height="250" width="100%" src="https://www.youtube.com/embed/l7VwI1Vkos4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
	</div>
	<div class="column">
	<h2 style="text-align: center;text-transform: uppercase;">how to import demo content moddroid themes</h2>
	<iframe height="250" width="100%" src="https://www.youtube.com/embed/aSAuUL30q44" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
	</div>
