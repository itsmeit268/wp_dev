...
<table class="table table-striped table-borderless">
	<tbody>
			<tr>
				...
				<td itemprop="name" >
					<?php echo trim(strip_tags($title_ps)); ?>
				</td>
			...
			<tr>
				...
				<td  class="text-truncate ">
					<a href="' .get_term_link( $term->slug, $developer) .'" title="Developer by ' .$term->name .'">
						' .$term->name .'
					</a>
				</td>';
				}
			...
			<tr>
				...
				<td  class="text-truncate ">
					...
					echo '
					<a class="label" href="'.get_category_link($cat->cat_ID).'">
						' . $cat->cat_name . '
					</a>';
					if (++$i == 1) break;
					}
			...
			<tr>
				...
				<td>
					<a href="<?php echo $url_ps_sources; ?>" target="_blank" rel="nofollow"><img style="max-height: 1.5rem;" src="<?php echo EX_THEMES_URI; ?>/assets/img/google-play-icon.png" alt="Google Play" width="81" height="24"></a>
				</td>
			</tr>
			<?php } ?>
			<noscript>
            ...
            <span itemprop="softwareRequirements" style="display:none"><?php _e('Android', THEMES_NAMES); ?> 5.0</span>
