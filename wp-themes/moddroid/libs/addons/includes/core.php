...
function add_post_metaboxes() {
    ...
    add_meta_box( 'wpwp_apks_details', __( 'App Details', THEMES_NAMES ), 'ex_themes_apk_details_', 'post', 'normal', 'high');
    add_meta_box( 'repeatable-fields', __( 'Download Link Box', THEMES_NAMES ), 'download_link_box', 'post', 'normal', 'high');
	if ($article_content) {
    add_meta_box( 'wpwp_desc', __( 'Entry Content', THEMES_NAMES ), 'apk_entry_content', 'post', 'normal', 'high');
	}    
...
function ex_themes_apk_details_() {
    ...
    if ( $version === FALSE or $version == '' ) $version = $versionGP;
    ...
    for($i=0; $i<5; $i++){
        // echo $gambarX21[$i]."<br />";backgrounds_GP
    }	
	$tosizes			= '=w1400-rw';
	$random				= mt_rand(1, 3);	
	if(get_post_meta( $post->ID, 'wp_images_GP', true )){
    $backgroundgp		= get_post_meta( $post->ID, 'wp_images_GP', true )[$random].$tosizes;
	} else {
    $backgroundgp		= get_post_meta( $post->ID, 'wp_images_GP', true )[$random];
	}
    $background_gp		= get_post_meta( $post->ID, 'wp_backgrounds_GP', true );
    $modfeatures		= get_post_meta( $post->ID, 'wp_mods', true );
    ...
    $ps_sources			= get_post_meta( $post->ID, 'wp_ps_sources', true );
...
<table class="responsive-table">
    ...
    <tbody> 
		...
		<tr>
			<th scope="row"> 
			<b style="text-transform:capitalize"><?php _e('apps Google Play (Get it on)', THEMES_NAMES); ?></b>
			...
			<td data-title="Value"> 
			<?php if ($titleID) { ?>
			<input style="width:98%; " type="text" name="wp_ps_sources" value="https://play.google.com/store/apps/details?id=<?= $titleID ?>" /></p>
			<?php } else { ?>
			<input style="width:98%; " type="text" name="wp_ps_sources" value="<?= $ps_sources ?>" /></p>	
			<?php } ?>
		...
		<tr>
			<th scope="row"> 
			<b style="text-transform:capitalize"><?php _e('apps background images', THEMES_NAMES); ?> </b>
		...
		<tr>
			...
			<td data-title="Value"> 
			<input style="width:98%"  type="text" name="wp_version_GP" value="<?= $versionGP ?>" />
			</td> 
		</tr>
		...
		<tr>
			...
			<td data-title="Value"> 
			<input style="width:98%"  type="text" name="wp_version" value="<?= $version ?>" />
			</td> 
		</tr>
		 
		<tr>
			<th scope="row"> 
			<b style="text-transform:capitalize"><?php _e('apps developers', THEMES_NAMES); ?></b>
		...
		<tr>
			<th scope="row"> 
			<b style="text-transform:capitalize"><?php _e('apps installs', THEMES_NAMES); ?></b>
			<a class="toggle" href="#wp_installs_GP">?</a>
			<p class="toggle-content" id="wp_installs_GP" style="display:none;">
			<?php _e('Example', THEMES_NAMES); ?> :  <br>
			<strong>500.000.000</strong>
			</p>
			</th>
			<td data-title="Value"> 
			<input style="width:98%"  type="text" name="wp_installs_GP" value="<?= $installs ?>" />
			</td> 
		</tr>
		 
		<tr>
			<th scope="row"> 
			<b style="text-transform:capitalize"><?php _e('apps Average Rating', THEMES_NAMES); ?></b>
			<a class="toggle" href="#wp_rated_GP">?</a>
			<p class="toggle-content" id="wp_rated_GP" style="display:none;">
			<?php _e('Example', THEMES_NAMES); ?> :  <br>
			<strong>4.5</strong>
			</p>
			</th>
			<td data-title="Value"> 
			<input style="width:98%"  type="number" name="wp_rated_GP" value="<?= $rated ?>" />
			</td> 
		</tr>
		 
		<tr>
			<th scope="row"> 
			<b style="text-transform:capitalize"><?php _e('apps Number of Votes', THEMES_NAMES); ?></b>
			<a class="toggle" href="#wp_ratings_GP">?</a>
			<p class="toggle-content" id="wp_ratings_GP" style="display:none;">
			<?php _e('Example', THEMES_NAMES); ?> :  <br>
			<strong>28.536.990</strong>
			</p>
			</th>
			<td data-title="Value"> 
			<input style="width:98%"  type="number" name="wp_ratings_GP" value="<?= $ratings ?>" />
			</td> 
		</tr>
		 
		<tr>
			<th scope="row"> 
			<b style="text-transform:capitalize"><?php _e('OS Required', THEMES_NAMES); ?></b>
...
var show=function(t){t.style.display="block"},hide=function(t){t.style.display="none"},toggle=function(t){"block"!==window.getComputedStyle(t).display?show(t):hide(t)};document.addEventListener("click",function(t){if(t.target.classList.contains("toggle")){t.preventDefault();var e=document.querySelector(t.target.hash);e&&toggle(e)}},!1);
	...
	<div id='metabox_mdr' style="margin-left: 10px;">
	 
	<b style="text-transform:capitalize"><?php _e('App Desc', THEMES_NAMES); ?></b>
    <p>
	<?php wp_editor(($desck), 'wp_desck_GP', array(
      'textarea_name' => 'wp_desck_GP', 
	  'media_buttons' => false,
      'textarea_rows' => 3,
      'tabindex' => 3,
      'tinymce' => array(
    ...
    <b style="text-transform:capitalize;"><?php _e('App what news', THEMES_NAMES); ?> </b>
 
	 <p>
	<?php wp_editor(($whatnews), 'wp_whatnews_GP', array(
      'textarea_name' => 'wp_whatnews_GP', 
	  'media_buttons' => false,
      'textarea_rows' => 3,
      'tabindex' => 3,
      'tinymce' => array(
    ...
    <b style="text-transform:capitalize"><?php _e('mod features for homes.. etc', THEMES_NAMES); ?></b>	
 
	 <p>
	<?php wp_editor(($modfeatures), 'wp_mods', array(
      'textarea_name' => 'wp_mods', 
	  'media_buttons' => false,
      'textarea_rows' => 3,
      'tabindex' => 3,
      'tinymce' => array(
    ...
    <b style="text-transform:capitalize"><?php _e('mod features for single post', THEMES_NAMES); ?></b>
    <p><b style="text-transform:capitalize"><?php _e('Title Mod', THEMES_NAMES); ?></b></p>
	<p><input style="width:98%;margin-top:10px;" type="text" name="wp_title_wp_mods" value="<?= $wp_title_wp_mods ?>" /></p>
	
    <b style="text-transform:capitalize"><?php _e('Descripton Mod', THEMES_NAMES); ?></b>
 
	<p>
	<?php wp_editor(($wp_mods_post), 'wp_mods_post', array(
      'textarea_name' => 'wp_mods_post', 
	  'media_buttons' => false,
      'textarea_rows' => 3,
      'tabindex' => 3,
      'tinymce' => array(
    ...
    <b style="text-transform:capitalize"><?php _e('mod features for single post alt 2', THEMES_NAMES); ?></b>
    <p><b style="text-transform:capitalize"><?php _e('Title Mod alt 2', THEMES_NAMES); ?></b></p>
	<p><input style="width:98%;margin-top:10px;" type="text" name="wp_title_wp_mods_2" value="<?= $wp_title_wp_mods_2 ?>" /></p>
	
    <b style="text-transform:capitalize"><?php _e('Descripton Mod', THEMES_NAMES); ?></b>
	 
	<p>
	<?php wp_editor(($wp_mods_post2), 'wp_mods_post2', array(
      'textarea_name' => 'wp_mods_post2', 
	  'media_buttons' => false,
      'textarea_rows' => 3,
      'tabindex' => 3,
      'tinymce' => array(
    ...
    <b style="text-transform:capitalize"><?php _e('mod features for single post alt 3', THEMES_NAMES); ?></b>
    <p><b style="text-transform:capitalize"><?php _e('Title Mod alt 3', THEMES_NAMES); ?></b></p>
	<p><input style="width:98%;margin-top:10px;" type="text" name="wp_title_wp_mods_3" value="<?= $wp_title_wp_mods_3 ?>" /></p>
	
    <b style="text-transform:capitalize"><?php _e('Descripton Mod', THEMES_NAMES); ?></b>
	 
	<p>
	<?php wp_editor(($wp_mods_post3), 'wp_mods_post3', array(
      'textarea_name' => 'wp_mods_post3', 
	  'media_buttons' => false,
      'textarea_rows' => 3,
      'tabindex' => 3,
      'tinymce' => array(
...
function download_link_box() {
	...
	<center>
	<p><strong style="text-transform:capitalize;color:black"><?php _e('Here for Default Download Links from Sources Google Play Store', THEMES_NAMES); ?> 
	<br><?php _e('Please copy this link to download box', THEMES_NAMES); ?><br><?php _e('if you not copy the link.. download link use this for default link....', THEMES_NAMES); ?></strong></p>
	</center>
	<thead>
	<tr> 
		<th width="0%" style='display:none'><?php _e('Type', THEMES_NAMES); ?></th> 
		<th width="15%"><?php _e('Size', THEMES_NAMES); ?></th> 
	...
	<?php if ($link_download_apksupport) { ?>
    <tr> 
		<td data-title="Type" name="type_download_apksupport" style='display:none' ><input type="text" class="widefat " name="type_download_apksupport" value="<?php echo $type_download_apksupport; ?>" /></td>
		<td data-title="Size" name="size_download_apksupport"><input type="text" class="widefat " name="size_download_apksupport" value="<?php echo $size_download_apksupport; ?>" /></td>
		<td data-title="Name" name="name_download_apksupport"><input type="text" class="widefat " name="name_download_apksupport" value="<?php echo $name_download_apksupport; ?>" /></td>
		<td data-title="Link" name="link_download_apksupport"><input style="width:100%" type="text" name="link_download_apksupport" value="<?php echo $link_download_apksupport; ?>" /> </td>
    </tr> 
	<?php } ?>	
	</tbody>
	...
	<table class="content-table"> 
	<center> 
	<p><strong style="text-transform:capitalize;color:black"><?php _e('Here for Default Download Links from Sources Google Play Store', THEMES_NAMES); ?><br> <?php _e('Please copy this link to download box', THEMES_NAMES); ?><br> <?php _e('if you not copy the link.. download link not showing up...', THEMES_NAMES); ?></strong></p>
	</center>
	<thead>
	<tr> 
		<th width="15%"><?php _e('Size', THEMES_NAMES); ?></th> 
		<th width="30%"><?php _e('Name', THEMES_NAMES); ?></th> 
		<th width="65%"><?php _e('Link', THEMES_NAMES); ?></th>
	</tr>
	</thead>
	<tbody> 
	...
	<?php if ($downloadlink_ori) { ?>
    <tr> 
      <td data-title="Size" name="size_downloadlinks_orig"><input type="text" class="widefat " name="size_downloadlinks_orig" value="<?php echo $size_downloadlinks_orig; ?>" /></td> 
      <td data-title="Name" name="name_downloadlinks_ori"><input type="text" class="widefat " name="name_downloadlinks_ori" value="<?php echo $name_downloadlinks_ori; ?>" /></td> 
      <td data-title="Link" name="downloadlink_ori"><input style="width:100%" type="text" name="downloadlink_ori" value="<?php echo $downloadlink_ori; ?>" /> </td>
    </tr> 
	<?php } ?>
	<?php if ($downloadlink_ori_1) { ?>
    <tr> 
      <td data-title="Size" name="size_downloadlinks_orig_1"><input type="text" class="widefat " name="size_downloadlinks_orig_1" value="<?php echo $size_downloadlinks_orig_1; ?>" /></td> 
      <td data-title="Name" name="name_downloadlinks_ori_1"><input type="text" class="widefat " name="name_downloadlinks_ori_1" value="<?php echo $name_downloadlinks_ori_1; ?>" /></td> 
      <td data-title="Link" name="downloadlink_ori_1"><input style="width:100%" type="text" name="downloadlink_ori_1" value="<?php echo $downloadlink_ori_1; ?>" /> </td>
    </tr> 
	<?php } ?>
	<?php if ($downloadlink_ori_2) { ?>
    <tr> 
      <td data-title="Size" name="size_downloadlinks_orig_2"><input type="text" class="widefat " name="size_downloadlinks_orig_2" value="<?php echo $size_downloadlinks_orig_2; ?>" /></td> 
      <td data-title="Name" name="name_downloadlinks_ori_2"><input type="text" class="widefat " name="name_downloadlinks_ori_2" value="<?php echo $name_downloadlinks_ori_2; ?>" /></td> 
      <td data-title="Link" name="downloadlink_ori_2"><input style="width:100%" type="text" name="downloadlink_ori_2" value="<?php echo $downloadlink_ori_2; ?>" /> </td>
    </tr> 
	<?php } ?>
	 </tbody>
	</table>
	...
	<table class="content-table"> 
	<center> 
	<p><strong style="text-transform:capitalize;color:black"><?php _e('Here for Default Download Links from Sources', THEMES_NAMES); ?><br> <?php _e('Please copy this link to download box', THEMES_NAMES); ?><br> <?php _e('if you not copy the link.. download link from Sources not showing up...', THEMES_NAMES); ?></strong></p>
	</center>
	<thead>
	<tr> 
		<?php if ($sizedownloadlink_gma) { ?><th width="15%"><?php _e('Size', THEMES_NAMES); ?></th> <?php } ?>
		<th width="30%"><?php _e('Name', THEMES_NAMES); ?></th> 
		<th width="65%"><?php _e('Link', THEMES_NAMES); ?></th>
	</tr>
	</thead>
	...
	<tr> 
		<?php if ($typexx) { ?>
		<th width="15%" class="more_info"><?php _e('Tipes', THEMES_NAMES); ?> <div class="popup">APK / ZIP / OBB</div></th>
		<?php } if ($sizexx) { ?>
		<th width="15%" class="more_info"><?php _e('Sizes', THEMES_NAMES); ?> <div class="popup">APK / ZIP / OBB</div></th>
		<?php } ?>
		<th width="30%" class="more_info"><?php _e('Url Names', THEMES_NAMES); ?> <div class="popup">APK / ZIP / OBB</div></th>
		<th width="40%" class="more_info"><?php _e('Url Links', THEMES_NAMES); ?> <div class="popup">APK / ZIP / OBB</div></th> 
	</tr>
	</thead>
	<tbody>
	<center><p><strong style="text-transform:uppercase!important;color:#2271b1"><?php _e('Here for Default Download Links from Sources, you can\'t add or remove this.', THEMES_NAMES); ?> <br><?php _e('but you can copy this link for you insert to download link page', THEMES_NAMES); ?></strong></p></center>
	<?php
	$i		= 0;
	if($downloadlinks) {
	...
	<div class="cmb-row cmb-type-text cmb-repeat-group-field table-layout" data-fieldtype="text">
	<div class="cmb-th">
	<label for="group_downloads_links_tipe"><?php _e('Tipes', THEMES_NAMES); ?></label>
	</div>
	<div class="cmb-td">
	<input type="text" class="regular-text" name="tipe[]" id="group_downloads_links_tipe" value="<?php if($field['tipes'] != '') echo esc_attr( $field['tipes'] ); ?>" >
	</div>
	</div>
	...
	<div class="cmb-td">
	<input type="text" class="regular-text" name="tipe[]" id="group_downloads_links_tipe" value="" >
	</div>
	</div>
...
function repeatable_meta_box_save($post_id) {
    ...
    $tipes							= $_POST['tipes'];
    $tipes1							= $_POST['tipe'];
	if ( $tipes === FALSE or $tipes == '' ) $tipes = $tipes1;
    $sizes1							= $_POST['sizes1'];
    $names							= $_POST['name'];
    $urls							= $_POST['url'];
    $notes							= $_POST['notes'];
    ...
    for ( $i = 0; $i < $count; $i++ ) {
		...
		$new[$i]['notes'] = $notes[$i];
		if ( $tipes1[$i] != '' )
		$new[$i]['tipes'] = stripslashes( strip_tags( $tipes1[$i] ) );
		if ( $sizes1[$i] != '' )
...
/*
 * Admin Show Thumbnails into overview 
 */
...
function wpwm_save_postdata( $post_id ) {
    ...
    $wpwm_meta = array('wp_version_GP', 'wp_version',  'link_download_apksupport','name_download_apksupport','size_download_apksupport','type_download_apksupport','wp_background_GP', 'wp_backgrounds_GP', 'wp_downloadapkxapkg', 'wp_downloadapkgk', 'wp_title_wp_mods','wp_title_wp_mods_2','wp_title_wp_mods_3','wp_downloadapkxapkpremier', 'wp_mods_post2', 'wp_mods_post3',  'wp_mods_post', 'wp_namedownloadlink', 'wp_size_GP', 'wp_GP_ID', 'wp_sizes', 'wp_sizes_GP', 'wp_source_url', 'wp_downloadlink', 'wp_title', 'wp_GP_ID2', 'wp_ps_sources', 'wp_title_id', 'wp_title_id2', 'wp_developers', 'wp_developers2', 'wp_contentrated', 'wp_installs','wp_requires', 'wp_updates', 'wp_ratings', 'wp_rated', 'wp_whatnews', 'wp_gambar1', 'wp_gambar2', 'wp_gambar3', 'wp_gambar4', 'wp_gambar5', 'wp_gambar6', 'wp_youtube', 'wp_desck', 'wp_desckapgk', 'wp_desckapgk', 'wp_contentratingapgk', 'wp_updateapgk', 'wp_requiresapgk', 'wp_installsapgk', 'wp_developersapgk', 'wp_versionapgk', 'wp_judulapgk', 'wp_persenapgk', 'wp_modfeatures', 'wp_modfeatures3','wp_images_GP',  'wp_mods', 'wp_desck_GP',  'wp_youtube_GP', 'wp_whatnews_GP', 'wp_persen_GP', 'wp_ratings_GP', 'wp_rated_GP', 'wp_contentrated_GP', 'wp_updates_GP', 'wp_requires_GP', 'wp_installs_GP', 'wp_version_GP', 'wp_developers2_GP', 'wp_developers_GP', 'wp_title_GP', 'wp_GP_ID', 'wp_poster_GP',  );
...
function custom_postimage_meta_box(){
    ...
    foreach($post_types as $pt){
        add_meta_box('custom_postimage_meta_box', __( 'Background Image', THEMES_NAMES),'custom_postimage_meta_box_func', $pt, 'side', 'low');
    }
}
...
function custom_postimage_meta_box_func($post){  
    ...
    foreach($meta_keys as $meta_key){
        ...
        <div class="custom_postimage_wrapper" id="<?php echo $meta_key; ?>_wrapper" style="margin-bottom:20px;">
			...
			<p><?php _e('Add Background Image', THEMES_NAMES); ?> <br><?php _e('Best use Dimensions', THEMES_NAMES); ?>: <b>1024px</b> × <b>500px</b></p>
			<div id="major-publishing-actions">
				<div id="delete-action">
				<a class="submitdelete deletion" style="display: <?php echo ($image_meta_val!=''?'block':'none'); ?> color: #2271b1;transition-property: border,background,color;transition-duration: .05s;transition-timing-function: ease-in-out;line-height: 2.30769231;" onclick="custom_postimage_remove_image('<?php echo $meta_key; ?>');"><?php _e('Remove Image', THEMES_NAMES); ?></a>				
				</div>
				<div id="publishing-action"> 
					<a class="button button-primary button-large" onclick="custom_postimage_add_image('<?php echo $meta_key; ?>');"><?php _e('add image', THEMES_NAMES); ?></a>
    ...
    function custom_postimage_add_image(key){
        ...
        custom_postimage_uploader.on('select', function() {
            ...
            /* var img_url2 = <?php echo get_post_meta( $post->ID, 'wp_backgrounds_GP', true ); ?>; */
