...
$dokan_vendor_list_heading = isset( $nest_theme_mod['dokan_vendor_list_heading'] ) ? $nest_theme_mod['dokan_vendor_list_heading'] : '';
?>
...
<div class="row">
    <div class="col-md-5 col-sm-12 m-auto">
        <div class="vendot_list_heading text-center">
            <h1 class="display-2 mb-50"><?php echo esc_attr($dokan_vendor_list_heading); ?></h1>
        </div>
        <?php ?>
